...
```powershell
git -C 'C:\Users\Ranky\Documents\Coding\Games\Mouse_raid' status --porcelain; git -C 'C:\Users\Ranky\Documents\Coding\Games\Mouse_raid' switch -c m2-testlabor
```
...
```powershell
$src = 'C:\Users\Ranky\Documents\Coding\Games\Mouse_raid'
...
| QR-Zwischenfälle | Anzahl je Grund, z. B. `scan-timeout 1 · not-a-payload 2`; `–` wenn keiner | Zeitleisten-Einträge `qr:error` (Detail) |
